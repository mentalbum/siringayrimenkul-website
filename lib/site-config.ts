export const siteConfig = {
  ...
  description:
    "Eryaman emlakçısı Şirin Gayrimenkul — satılık ve kiralık için Eryaman'ın 11 mahallesini, komşu Yenimahalle mahallelerini ve 570'ten fazla site/rezidansı yakından tanıyan yerel emlak ofisi. Evinizi satmayı veya kiraya vermeyi düşünüyorsanız fiyatı birlikte belirleyelim.",
