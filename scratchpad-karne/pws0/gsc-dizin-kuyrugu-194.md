...
> 23.08 — ŞFK TABELA KANITI (Street View Haz 2024): çitte "ŞEHİT FERHAT KOÇ SİTESİ" + "NO:8" — onaylanan birleştirme sahadan da doğrulandı; resmî adres Şehit Haydar Yolcu Cd. No:8 (8-A..8-F blok adlarının kaynağı; KEOS kapı katmanına işlenmemiş). Görsel Özgün'e iletildi, ayrıntı sorunlu-siteler.md sonunda. Damla/301 sırasına etkisi yok — (16) numaralı karar planı aynen geçerli.
> 23.08 ~19:30 — ŞFK yeni slug isteği ELDEN DENENDİ (UI, Chrome): denetim doğru URL'de "URL Google'da yok / Keşfedildi - şu anda dizine eklenmiş değil" (bulunma: sitemap.xml + guzelkent-mahallesi sayfası; API'nin bugünkü 'URL unknown' cevabı geçici tutarsızlıkmış). DİZİNE EKLENMESİNİ İSTE tıklandı → "Kota Aşıldı — yarın tekrar deneyin" = İSTEK İŞLENMEDİ, işaret KONMADI. Not: bugün gündüz istek gönderilmediği hâlde kota kapalı görünüyor (dünkü pencere hâlâ sindiriliyor olmalı). ŞFK İLK SIRA olmayı sürdürüyor — 22:47 damlası ve/veya yarın öğleden sonra.
